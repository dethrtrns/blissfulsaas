      ...
      <div className={`flex-1 flex flex-col bg-slate-50/30 ${!selectedSession ? 'hidden md:flex' : 'flex'}`}>
        {!selectedSession ? (
          <div className="flex-1 flex flex-col items-center justify-center p-12 text-center">
            ...
            <h3 className="text-xl font-heading font-medium text-slate-800 mb-2">Message History</h3>
          ...
          <>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-sm font-bold text-slate-900 leading-none">
                    Conversation with Dr. {selectedSession.therapist?.firstName}
                  </h3>
            ...
            <div className="flex-1 overflow-y-auto p-8 space-y-6">
              {loading ? (
                ...
                <div className="flex flex-col h-full items-center justify-center text-slate-300 opacity-50 space-y-2">
                  ...
                  <p className="text-xs font-bold uppercase tracking-widest">No messages found for this session</p>
                </div>
              ) : (
                messages.map((m) => {
            ...
            <div className="p-4 bg-white/50 border-t border-slate-100 text-center">
              <p className="text-[9px] font-bold text-slate-400 uppercase tracking-[0.2em]">
                Secure Clinical History — Read Only
              </p>
            </div>
          </>
        )}
