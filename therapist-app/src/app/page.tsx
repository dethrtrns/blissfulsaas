...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#F8FAF9]">
      <LandingNavbar portal="therapist" />
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col items-center gap-8">
            ...
            <p className="text-[var(--text-light)] max-w-md">
               The premier digital workspace for clinical practice management and ethical mastery.
            </p>
            ...
            <div className="pt-8 border-t border-[rgba(33,77,62,0.05)] w-full text-[10px] font-bold uppercase tracking-widest text-[var(--primary)]/20">
              © {new Date().getFullYear()} Blissful Station • Provider Ecosystem
            </div>
          </div>
        </div>
      </footer>
